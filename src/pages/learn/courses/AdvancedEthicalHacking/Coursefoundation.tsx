...
const courseVideos: ChapterVideos[] = [
  {
    ...
    lessons: [
      {
        id: "lesson-1-1",
        title: "Bypassing Antivirus & EDR",
        videoUrl: "https://www.youtube.com/watch?v=y2z0XfJTH1o",
      },
      {
        id: "lesson-1-2",
        title: "Evading Firewalls and IDS",
        videoUrl: "https://www.youtube.com/watch?v=Qg5pEJkF49w",
      },
      {
        id: "lesson-1-3",
        title: "Covering Your Tracks",
        videoUrl: "https://www.youtube.com/watch?v=7tx1xVpDPnE",
      },
      {
        id: "lesson-1-4",
        title: "Anonymity and OpSec",
        videoUrl: "https://www.youtube.com/watch?v=8XjmH0I0sZs",
      },
    ],
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        videoUrl: "https://www.youtube.com/watch?v=2nsK3dGQ9mQ",
      },
      {
        id: "lesson-2-3",
        title: "Exploit Development Tools",
        videoUrl: "https://www.youtube.com/watch?v=tA1WqJgA1iM",
      },
      {
        id: "lesson-2-4",
        title: "Reverse Engineering for Exploits",
        videoUrl: "https://www.youtube.com/watch?v=5j7G2aGfLCU",
      },
    ],
  },
  {
    id: "chapter-3",
    title: "Red Teaming & Advanced Attacks",
    lessons: [
      {
        id: "lesson-3-1",
        title: "Red Team vs Blue Team",
        videoUrl: "https://www.youtube.com/watch?v=6GzVJk3XGcs",
      },
      {
        id: "lesson-3-2",
        title: "Advanced Social Engineering",
        videoUrl: "https://www.youtube.com/watch?v=8ofn6mQT5nI",
      },
      {
        id: "lesson-3-3",
        title: "Physical Security Testing",
        videoUrl: "https://www.youtube.com/watch?v=3n72f3K6h8Q",
      },
      {
        id: "lesson-3-4",
        title: "Command and Control (C2) Frameworks",
        videoUrl: "https://www.youtube.com/watch?v=UfS0lR5sGJY",
      },
    ],
  },
  {
    id: "chapter-4",
    title: "Advanced Defensive Evasion",
    lessons: [
      {
        id: "lesson-4-1",
        title: "Living off the Land Binaries (LOLBins)",
        videoUrl: "https://www.youtube.com/watch?v=H5C6U5xP_kk",
      },
      {
        id: "lesson-4-2",
        title: "Fileless Malware Techniques",
        videoUrl: "https://www.youtube.com/watch?v=G2Sjo4YjaVQ",
      },
      {
        id: "lesson-4-3",
        title: "Persistence Mechanisms",
        videoUrl: "https://www.youtube.com/watch?v=Lv9sOio7Vpo",
      },
      {
        id: "lesson-4-4",
        title: "Privilege Escalation Techniques",
        videoUrl: "https://www.youtube.com/watch?v=DSw1N3C5WqQ",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        id: "lesson-5-1",
        title: "Cobalt Strike Basics",
        videoUrl: "https://www.youtube.com/watch?v=U6vMy1yj2v4",
      },
      {
        id: "lesson-5-2",
        title: "Empire Framework",
        videoUrl: "https://www.youtube.com/watch?v=1sQH2IovS2o",
      },
      {
        id: "lesson-5-3",
        title: "Mimikatz and Credential Dumping",
        videoUrl: "https://www.youtube.com/watch?v=3P9h-o3UacQ",
      },
      {
        id: "lesson-5-4",
        title: "Advanced PowerShell Attacks",
        videoUrl: "https://www.youtube.com/watch?v=zS2o3NfTYjA",
      },
      {
        id: "lesson-5-5",
        title: "Custom Red Team Tools",
        videoUrl: "https://www.youtube.com/watch?v=bHqBHRH0D2M",
      },
    ],
  },
];
...
export default function Coursefoundation() {
  ...
  const [currentLesson, setCurrentLesson] = useState<LessonVideo | null>(
    courseVideos[0].lessons[0]
  );
  ...
  const course = courses.find((c) => c.id === parseInt(id || "6"));
  ...
  const saveProgress = async (lessonId: string, progress: number) => {
    ...
    try {
      ...
      const updatedLessonProgresses = {
        ...courseProgress.lessonProgresses,
        [lessonId]: progress,
      };
      ...
      await updateDoc(progressRef, {
        [`courses.${course.courseId}.lessonProgresses`]:
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            {course.title} - Course Foundation
          </h1>
          <p className="text-gray-600">
            Interactive learning experience with video lessons
          </p>
        </div>
              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                {courseVideos.map((chapter) => (
                  ...
                  >
                    ...
                    >
                      <span className="font-semibold text-left text-gray-900 text-sm">
                        {chapter.title}
                      </span>
