...
import { logCourseAccess } from "../../../../utils/auditLogger";
import Quiz from "../../../../components/Quiz";

export default function IntroductionToCyberSecurity() {
  ...
  const course = courses.find(c => c.courseId === "intro-cybersecurity");
  ...
  }, [currentUser, course.courseId, totalLessons, course.title]);
