    ...
    lessons: [
      {
        ...
        videoUrl: "https://www.youtube.com/watch?v=pJ3IPRqiD2E"
      },
      {
        id: "lesson-1-2",
      ...
      },
      {
        ...
        videoUrl: "https://www.youtube.com/watch?v=vSJLt4mJqZs"
      },
      {
        id: "lesson-1-5",
        title: "Security Misconfigurations",
        videoUrl: "https://www.youtube.com/watch?v=QfU-Ex9lD2o"
      }
    ]
  },
  {
    ...
    lessons: [
      {
        ...
        videoUrl: "https://www.youtube.com/watch?v=hLQHT7vAeqg"
      },
      {
        id: "lesson-2-2",
        title: "Manual vs Automated Testing",
        videoUrl: "https://www.youtube.com/watch?v=u6E1wsVOkaw"
      },
      {
        id: "lesson-2-3",
        title: "Exploitation Techniques",
        videoUrl: "https://www.youtube.com/watch?v=VXc_FV_UH2c"
      },
      {
        id: "lesson-2-4",
        title: "Secure Coding Practices",
        videoUrl: "https://www.youtube.com/watch?v=VWlT0lRMLk"
      },
      {
        id: "lesson-2-5",
        title: "Input Validation and Parameterized Queries",
        videoUrl: "https://www.youtube.com/watch?v=lEn6s5d8l7c"
      }
    ]
  },
  {
    ...
    lessons: [
      {
        id: "lesson-3-1",
        title: "API Security",
        videoUrl: "https://www.youtube.com/watch?v=8z2Z_sVWlUU"
      },
      {
        id: "lesson-3-2",
        title: "Web Application Firewalls",
        videoUrl: "https://www.youtube.com/watch?v=IMN9jX3Oyeo"
      },
      {
        id: "lesson-3-3",
        title: "CSP and HTTP Security Headers",
        videoUrl: "https://www.youtube.com/watch?v=9h7WIMy8U7c"
      },
      {
        id: "lesson-3-4",
        title: "SSRF and CSRF",
        videoUrl: "https://www.youtube.com/watch?v=OyxRSZP5zkg"
      },
      {
        id: "lesson-3-5",
        title: "Tools of the Trade: Burp Suite and OWASP ZAP",
        videoUrl: "https://www.youtube.com/watch?v=t52Tw3y_mN8"
      }
    ]
  }
];
...
export default function Coursefoundation() {
  ...
  const course = courses.find(c => c.id === parseInt(id || "2"));
